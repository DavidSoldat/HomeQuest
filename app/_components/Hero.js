...
function Hero() {
  return (
    <div className='px-3 sm:px-5 pt-10 md:pt-0 2lx:ml-10 flex flex-col md:flex-row xl:pl-80 md:pl-3 md:gap-5 lg:gap-0 full-height-minus-nav relative '>
      <div className='md:w-2/5 self-center md:py-24 mb-8'>
        ...
        <Link
          className='px-4 py-3 text-center bg-primary-navy text-primary-lightGray rounded-lg text-lg'
          href='/signin'
        >
